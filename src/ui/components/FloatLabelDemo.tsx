    ...
    return (
        <DemoSection title={t('float-label')} description={t('float-label-desc') as string} icon={LabelOutlined} color="#FF9800">
            <Grid container spacing={3}>
                <Grid size={{ xs: 12, sm: 4 }}><TextField label={t('username')} fullWidth /></Grid>
                <Grid size={{ xs: 12, sm: 4 }}><TextField label={t('username')} fullWidth defaultValue="admin" /></Grid>
                <Grid size={{ xs: 12, sm: 4 }}><TextField label={t('username')} fullWidth variant="filled" defaultValue="admin" /></Grid>
            </Grid>
        </DemoSection>
    );
}
